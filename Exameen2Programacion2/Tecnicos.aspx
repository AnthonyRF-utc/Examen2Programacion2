<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Tecnicos.aspx.cs" Inherits="Exameen2Programacion2.Tecnicos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
    <h1>PAGINA DE TECNICOS</h1>
</div>
 ...
 <div class="container text-center">
     ID: <asp:TextBox ID="tIDtec" class="form-control" runat="server"></asp:TextBox>
     Nombre: <asp:TextBox ID="tNomb" class="form-control" runat="server"></asp:TextBox>
