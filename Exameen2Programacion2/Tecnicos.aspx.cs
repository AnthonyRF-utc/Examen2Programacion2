...
namespace Exameen2Programacion2
{
    public partial class Tecnicos : System.Web.UI.Page
    {
        ...
        {
            int valor = Clases.Tecnicos.INSERTAR_TEC(tNomb.Text, tEspecialidad.Text);
        ...
        {
            int valor = Clases.Tecnicos.BORRAR_TEC_ID(int.Parse(tIDtec.Text));
        ...
        {
            int valor = Clases.Tecnicos.ACTUALIZAR_TEC_ID(int.Parse(tIDtec.Text), tNomb.Text, tEspecialidad.Text);
